...
type Prescription struct {
	...
	Diagnosis       datatypes.JSON `json:"diagnosis" gorm:"type:jsonb;default:'[]'"`        
	Medications     datatypes.JSON `json:"medications" gorm:"type:jsonb;default:'[]'"`
	Investigations  datatypes.JSON `json:"investigations" gorm:"type:jsonb;default:'[]'"` 
